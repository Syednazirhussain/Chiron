<div class="modal modal-custom-centered modal-manage-trainer-location fade" id="editTrainerLocationModal">
            ...
            <div class="modal-body">
                ...
                <div class="form row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" placeholder="Add Location" type="text" name="location" id="location" value="Swan River, Manitoba, Canada">
                    </div>
