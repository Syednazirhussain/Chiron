...
jQuery(function () {
    ...
    var getOrigin = window.origin;

    var profileUrl = getOrigin + '/trainee/trainer-profile';
    var profileActiveUrl = getOrigin + '/trainee/trainer';

    if(url == profileUrl) {
        jQuery('.main-sidebar .sidebar a[href="' + profileActiveUrl + '"]').addClass('active');
    }
